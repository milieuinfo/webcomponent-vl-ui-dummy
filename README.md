# vl-ui-dummy
![GitHub issues](https://img.shields.io/github/issues-raw/milieuinfo/webcomponent-vl-ui-dummy) ![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/milieuinfo/webcomponent-vl-ui-dummy) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/milieuinfo/webcomponent-vl-ui-dummy)

Dummy test component

## Installatie
``` bash
$ npm install --save vl-ui-dummy
```

## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlDummy.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.

## Demo
De [demo](https://webcomponenten.omgeving.vlaanderen.be/demo/vl-dummy.html) pagina bevat een overzicht van de mogelijkheden met code voorbeelden. Lokaal opstarten kan met onderstaand [NPM](https://www.npmjs.com) script.
``` bash
$ npm run demo
```
...
## Versionering
We gebruiken [Semantic Versioning](https://semver.org) en voorzien elke release van release notes, zie een overzicht van de [releases](https://github.com/milieuinfo/webcomponent-vl-ui-dummy/releases).
...
## Credits
Zie de lijst van [ontwikkelaars](https://github.com/milieuinfo/webcomponent-vl-ui-dummy/graphs/contributors) die meegewerkt hebben aan de webcomponent.
